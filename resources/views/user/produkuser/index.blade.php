        ...
        <div class="flex justify-between items-center mt-6">
            ...
            <div class="flex space-x-4 overflow-x-auto">
                ...
                @foreach ($kategoris as $kategori)
                    <button class="px-6 py-2 bg-[#FFF6E4] text-[#3E3A33] rounded-full hover:bg-[#E9E0CE] border border-[#764C31]/50 hover:border-opacity-50">
            ...
            <div class="relative flex items-center">
                ...
                <input type="text" placeholder="Cari" class="px-4 py-2 pl-8 border border-[#764C31]/50 rounded-full focus:outline-none focus:ring-0 focus:border-[#764C31] w-28 focus:w-48 focus:placeholder-transparent focus:shadow-[0_0_8px_4px_#FFEBD0] transition-all duration-300 ease-in-out">
            </div>
        </div>
            ...
            @foreach ($kategoris as $kategori)
                @foreach ($kategori->produk as $produk)
                    <div class="border border-[#764C31]/50 rounded-xl shadow-md overflow-hidden">
                        <img src="https://via.placeholder.com/300" alt="{{ $produk->nama_produk }}" class="w-full h-48 object-cover">
                        <div class="p-4 bg-[#FFFBF4]">
                            ...
                            <a href="{{ route('produkuser.show', $produk->id) }}" class="text-[#3E3A33]/70 font-bold mt-2 underline block">Selengkapnya</a>
