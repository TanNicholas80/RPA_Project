<div id="carousel-example" class="relative max-w-7xl mt-36 mx-auto my-10" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-80 mx-4 sm:mx-8 md:mx-16 overflow-hidden rounded-lg lg:h-[550px]">
        <!-- Item 1 -->
    ...
    <!-- Slider indicators -->
    <div class="absolute z-30 flex flex-col items-center justify-center w-full top-1/2 -translate-y-1/2 text-center px-4">
        <h1 class="font-bold text-3xl sm:text-4xl md:text-5xl">WELCOME TO</h1>
        <h1 class="font-bold text-3xl sm:text-4xl md:text-5xl">RPA PROJECT PHOTO STUDIO</h1>
        <p class="text-xl sm:text-2xl mt-6">Capture Moments, Create Memories</p>
