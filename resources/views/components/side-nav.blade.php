...
<aside id="sidebar-multi-level-sidebar"
    ...
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto dark:bg-gray-800" style="background-color: #FFF6E4;">
        <ul class="space-y-2 font-medium mt-14">
            ...
            <li>
                <a href="{{ route('kategori.index') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white nav_hover dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-folder-open text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
            ...
            <li>
                <a href="{{ route('produk.index') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white nav_hover dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-basket-shopping text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
            ...
            <li>
                <a href="#"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white nav_hover dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-image text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
            ...
            <li>
                <a href="{{ route('addon.index') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white nav_hover dark:hover:bg-gray-700 group">
                    <i class="fa-solid fa-circle-plus text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
